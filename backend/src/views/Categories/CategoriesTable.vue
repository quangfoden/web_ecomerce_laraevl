  ...
  <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
    <div class="flex justify-between border-b-2 pb-3">
      <div class="flex items-center">
        <span class="ml-3">hiển thị {{categories.data.length}} danh mục</span>
      </div>
    </div>
    ...
    <table class="table-auto w-full">
      ...
      <tr>
        ...
        <TableHeaderCell field="img" :sort-field="sortField" :sort-direction="sortDirection"
                         @click="sortCategories('img')">
          Ảnh
        </TableHeaderCell>
      ...
      <tr v-for="(category, index) of categories.data">
        ...
        <td class="border-b p-2 max-w-[100px] whitespace-nowrap overflow-hidden text-ellipsis">
