<template>
  <div v-if="order">
    ...
    <!--  Customer Details-->
    <div>
      <h2 class="text-xl font-semibold mt-6 pb-2 border-b border-gray-300">Thông tin khách hàng</h2>
      <table>
        <tbody>
        <tr>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
      <div>
        <h2 class="text-xl font-semibold mt-6 pb-2 border-b border-gray-300">Địa chỉ thanh toán</h2>
    ...
    <!--    Order Items-->
    <div>
      <h2 class="text-xl font-semibold mt-6 pb-2 border-b border-gray-300">Sản phẩm</h2>
