  ...
  <div class="bg-white p-4 rounded-lg shadow animate-fade-in-down">
    <div class="flex justify-between border-b-2 pb-3">
      <div class="flex items-center">
        <span class="whitespace-nowrap mr-3">Số trang</span>
        ...
        <span class="ml-3">Tìm thấy {{ products.total }} sản phẩm</span>
      </div>
      <div>
    ...
    <table class="table-auto w-full">
      ...
      <tr>
        ...
        <TableHeaderCell field="size" :sort-field="sortField" :sort-direction="sortDirection"
                         @click="sortProducts('size')">
          Size
        </TableHeaderCell>
