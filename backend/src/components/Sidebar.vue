<template>
  <div
    class="min-w-[180px] w-[180px] transition-all bg-black text-white py-4 px-2"
  >
    <router-link
    ...
    >
      ...
      <span class="text-xs"> Danh mục sản phẩm </span>
    </router-link>
    <router-link
    ...
    <router-link
      :to="{ name: 'app.newscategory' }"
      class="flex items-center p-2 rounded transition-colors hover:bg-black/30"
    >
      <span class="mr-2 text-gray-300">
        <ViewListIcon class="w-5" />
      </span>
      <span class="text-xs"> Danh mục bài viết </span>
    </router-link>
    <router-link
      :to="{ name: 'app.orders' }"
      class="flex items-center p-2 rounded transition-colors hover:bg-black/30"
    ...
    <router-link
      :to="{ name: 'app.team-orders' }"
      class="flex items-center p-2 rounded transition-colors hover:bg-black/30"
    >
      <span class="mr-2 text-gray-300">
        <ViewListIcon class="w-5" />
      </span>
      <span class="text-xs"> Đơn hàng theo đội </span>
    </router-link>
    <router-link
      :to="{ name: 'app.users' }"
      class="flex items-center p-2 rounded transition-colors hover:bg-black/30"
    ...
    >
      ...
      <span class="text-xs"> Khách hàng </span>
    </router-link>
  </div>
</template>
