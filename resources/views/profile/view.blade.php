<x-app-layout>
    <div x-data="{
        ...
        }" class="mat-60  container mx-auto lg:w-2/3 p-5">
        @if (session('error'))
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 items-start">
            <div class="bg-white p-3 shadow rounded-lg md:col-span-2">
                <form x-data="{
                    ...
                    <h2 class="text-xl mt-6 font-semibold mb-2">Địa chỉ thanh toán</h2>
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div>
                            <x-input
                                type="text"
                    ...
                    <div class="flex justify-between mt-6 mb-2">
                        <h2 class="text-xl font-semibold">Địa chỉ nhận hàng</h2>
                        <label for="sameAsBillingAddress" class="text-gray-700">
                            <input @change="$event.target.checked ? shippingAddress = {...billingAddress} : ''"
                                   ...
                                   class="text-purple-600 focus:ring-purple-600 mr-2">Giống như thanh toán
                        </label>
                    </div>
                    <div class="grid grid-cols-2 gap-3 mb-3">
                        <div>
                    ...
                    <x-button class="w-full bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-lg shadow-md">Cập nhật</x-button>
                </form>
            </div>
            <div class="bg-white p-3 shadow rounded-lg">
                <form action="{{route('profile_password.update')}}" method="post">
                    @csrf
                    <h2 class="text-xl font-semibold mb-2">Cập nhật mật khẩu</h2>
                    <div class="mb-3">
                        <x-input
                            type="password"
                            name="old_password"
